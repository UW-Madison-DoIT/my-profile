...
public class LocalContactInfoResultSetExtractor implements ResultSetExtractor<ContactInformation> {
  ...
  public ContactInformation extractData(ResultSet rs) throws SQLException, DataAccessException {
    if(rs.next()) {
      ...
      try {
        ...
        value = ContactInformationMapper.convertToLocalContactInformation(json, new ContactInformation());
        return value;
      } catch (Exception e) {
